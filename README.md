# nvim-treesitter-queries-snakemake

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-snakemake/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-snakemake/actions/workflows/validate.yml)

Neovim tree-sitter queries for **snakemake**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-snakemake",
...
- [ ] Changes are scoped to `snakemake` — do not include files for other languages
